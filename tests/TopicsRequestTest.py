...
class TopicsRequesTest(unittest.TestCase):
    ...
    def testConstruct(self):
        ...
        request3 = meaningcloud.TopicsRequest(self.KEY, txt=self.text, topicType="a", extraheaders=extraHeaders,
        ...
        request4 = meaningcloud.TopicsRequest(self.KEY, url=url, topicType="a", extraheaders=extraHeaders,
                                              otherparams=otherparams)
        ...
        request5 = meaningcloud.TopicsRequest(self.KEY, doc=file, topicType="a", extraheaders=extraHeaders,
                                              otherparams=otherparams)
